            ...
            <Row className="align-items-center">
              <Col lg={7} className="mobMb10">
                <div className="d-flex align-items-center">
                  ...
                  <span className="borderGreen pl15 pr15 radius4 ml10">
                    Completed
                  </span>
                </div>
              </Col>
          ...
          <Row>
            <Col lg={8} md={8}>
              <div className="bgWhite radius pt30 pb10 pr20 pl20">
                ...
                <div className="bBottom pb10 mb20 borBottom">
                  <GAlign align="between">
                    <h3 className="fs20 fw700">Milestone payment</h3>
                    <h3 className="fs18 fw700">Total: $ 760.00 USD</h3>
                  </GAlign>
                  {/* Data Table To be added by GDataTable Component  */}
            ...
            <Col lg={4} md={4}>
              <div className="bgWhite radius pt25 pb20 pl15 pr15 mb10">
                <h2 className="fs20 colorBlack mb15 ">Task Done by</h2>

                <div className="border radius4 pt8 pb8 pl10 pr10 mb10">
