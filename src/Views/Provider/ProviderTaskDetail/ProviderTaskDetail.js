          ...
          <Row>
            <Col lg={8} md={8}>
              <div className="bgWhite radius pt30 pb10 pr20 pl20">
                ...
                <div className="bBottom mb20 pb20">
                  <h3 className="fs20 fw700 mb8">Interested provider (0/5)</h3>
            ...
            <Col lg={4} md={4}>
              <div className="radius pt25 pb20 pl15 pr15 mb10">
                <h2 className="fs20 colorBlack mb15">POSTED BY</h2>
                <div className="text-center border radius pt30 pb30 pl20 pr20">
                  ...
                  <p className="fs22 colorBlack mb5">Praveen Solanki</p>
                  <p className="fs16 colorPara mb15">13 hours ago</p>
                  <GButton>
